pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_FRONTEND = 'public.ecr.aws/t5n9y4h0/simple-mern-fe'
        DOCKER_IMAGE_BACKEND_S1 = 'public.ecr.aws/t5n9y4h0/simple-mern-be-micro-hello-service'
        DOCKER_IMAGE_BACKEND_S2 = 'public.ecr.aws/t5n9y4h0/simple-mern-be-micro-profile-service'
